...
public class extra2 {
	...
	public static void main(String s[]){
		  ...
		  Scanner sc=new Scanner(System.in);
		   ...
		   map.put(40,"fortyzero");
		   map.put(41,"fortyone");
		    map.put(42,"fortytwo");
		    map.put(43,"fortythree");
		    map.put(44,"fortyfour");
		    map.put(45,"fortyfive");
		    map.put(46,"fortysix");
		    map.put(47,"fortyseven");
		    map.put(48,"fortyeight");
		     map.put(49,"fortynine");
		   ...
		   map.put(91,"ninetyone");
		    map.put(92,"ninetytwo");
		    map.put(93,"ninetythree");
		    map.put(94,"ninetyfour");
		    map.put(95,"ninetyfive");
		    map.put(96,"ninetysix");
		    map.put(97,"ninetyseven");
		    map.put(98,"ninetyeight");
		     map.put(99,"ninetynine");
		     map.put(100,"hundred");
